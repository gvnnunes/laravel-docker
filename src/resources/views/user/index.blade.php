        ...
        <div class="container">
            <div class="row">
                ...
                {!! Form::open(['route' => 'user.store', 'method' => 'post']) !!}
                    @include('templates.formularios.text', ['name' => 'name', 'attributes' => ['placeholder' => 'Nome completo', 'class' => 'form-control', 'required']])
                    ...
                    @include('templates.formularios.date', ['name' => 'birth', 'value' => \Carbon\Carbon::now() ,'attributes' => ['class' => 'form-control']])
